...
export class Constants {
    public static readonly SectionsListName = 'SectionTemplates';
    public static readonly CopyButtonId = 'copySectionButton';
    public static readonly CanvasZoneEditSelector = '[data-automation-id="CanvasZoneEdit"]';
    public static readonly IsSitePageSelector = '_isSPSitePage';
